...
def main():
    ...
    parser_create.add_argument("-is", "--input-tileset", type=Path, help="A tileset to use instead of auto-generating one from the source image.", metavar="input_tileset")
    parser_create.add_argument("-om", "--output-tilemap", type=Path, help="The output path of the new tilemap.", metavar="output_tilemap")
    parser_create.add_argument("-os", "--output-tileset", type=Path, help="The output path of the new tileset.", metavar="output_tileset")
    parser_create.add_argument("-f", "--format", type=str, help="The format for the new tileset, either 8bpp or 4bpp (defaults to 4bpp if not specified).", metavar="tilemap_format")
    parser_create.add_argument("-p", "--palette", type=lambda x: int(x, 0), help="The palette to use (defaults to 0 if not specified).", metavar="tilemap_format")
    ...
    parser_palette.add_argument("input_image", type=Path, help="The image to modify.", metavar="input_image")
    parser_palette.add_argument("output_image", type=Path, help="The modified image.", metavar="output_image")
